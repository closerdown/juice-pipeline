...
> 소프트웨어 패키지 공급망에 대한 CVSS 점수 및 소스코드의 SAST 결과를 기반으로 서비스 맥락을 반영한 위험도를 산정하고, 위험 수준에 따라 Jenkins 빌드를 자동 차단하는 Risk-Based Security Gate 프로젝트

---

## 📌 프로젝트 소개

본 프로젝트는 K-Shield Junior 16기 과정에서 수행한 5인 팀 프로젝트입니다.
...
- 팀: 3조
- 형태: 5인 팀 프로젝트
- 주제: Risk-Based Security Gate 구축
<br>
